...
An R package for accessing Oregon school enrollment data from the Oregon
Department of Education (ODE). **16 years of data** (2010-2025) for
every school, district, and the state.
...
**Portland Public Schools** (District 1J) has lost 8,000 students in a
decade.
...
**Salem-Keizer SD** enrolls 40,000 students—Oregon’s largest outside
Portland.
...
Kindergarten enrollment dropped **12%** during COVID and hasn’t
recovered.
...
**Eugene SD** and **Springfield SD** serve Lane County’s 60,000
students.
...
Oregon tracks “ungraded” students—those not assigned to traditional
grade levels.
...
Over **2,000 students** classified as ungraded, often in alternative
programs.
...
- **Note:** Demographic breakdowns (race/ethnicity) are NOT included in
  Fall Membership files
