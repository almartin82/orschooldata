...
# data from the Oregon Department of Education website.
#
# ==============================================================================

#' Fetch Oregon enrollment data
#'
#' Downloads and processes enrollment data from the Oregon Department of
#' Education Fall Membership Reports.
#'
#' @param end_year A school year. Year is the end of the academic year - eg 2023-24
#'   school year is year '2024'. Valid values are 2010-2024.
...
#' portland_ps <- enr_2024 |>
#'   dplyr::filter(district_id == "1920")
#' }
