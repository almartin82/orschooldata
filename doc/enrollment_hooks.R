...
ggplot(state_totals, aes(x = end_year, y = n_students)) +
  ...
  labs(
    title = "Oregon Public School Enrollment (2010-2025)",
...
enr |>
  ...
  scale_y_continuous(labels = scales::comma) +
  labs(
    title = "Oregon Kindergarten Enrollment (2010-2025)",
